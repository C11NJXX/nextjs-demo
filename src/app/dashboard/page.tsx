...
const DashBoard = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-6xl mx-auto bg-base-100 rounded-2xl shadow-lg p-8 space-y-8">
          ...
          <Link
            ...
            className="bg-blue-100 hover:bg-blue-200 p-6 rounded-xl
             shadow-md hover:shadow-xl transition-all duration-200
              ease-in-out transform hover:scale-105 card"
          >
          ...
          <Link
            ...
            className="bg-yellow-100 hover:bg-yellow-200 p-6 rounded-xl
             shadow-md hover:shadow-xl transition-all duration-200 ease-in-out
              transform hover:scale-105 card"
          >
            <div className="flex items-center justify-between">
